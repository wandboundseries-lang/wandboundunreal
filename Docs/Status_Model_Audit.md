...
- Burn, Rooted, and Stunned do not decrement during start-turn ticks because their Godot timing is `turn_end`.
...
- End-turn Burn damage and Burn duration decay remain TODO.
- End-turn Rooted/Stunned duration decay remains TODO.
